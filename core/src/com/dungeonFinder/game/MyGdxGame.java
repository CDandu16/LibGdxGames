...
public class MyGdxGame extends ApplicationAdapter {
	...
	public void create () {
		...
		hpbarCamera = new OrthographicCamera(WIDTH,HEIGHT);
		hpbarCamera.update();
	}
...
//     	 centerPiece.draw(batch);//draws image to screen   
	 ...
	 */
	 public float HotNColdDenom(int height, int width, Sprite centerPiece){
		...
		float xDistance = 0;
		float yDistance = 0;
		float distanceHeight = (float)(height - centerPiece.getHeight()/2);
		float distanceWidth = (float)(width - centerPiece.getWidth()/2);
